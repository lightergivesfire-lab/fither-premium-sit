...
export function LeadMagnet() {
  ...
  return (
    <section id="lead-magnet" className="py-24 bg-background relative overflow-hidden">
          ...
          <div className="bg-card border border-border rounded-2xl p-8 lg:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4 text-balance">
